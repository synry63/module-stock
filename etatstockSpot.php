...
if($_GET['json']=="list")
{
	...
	$element->Product = $aRow->key[1];
	$element->Spot = $aRow->key[2];
...
print'<div class="row">';
print start_box("Liste des stocks par emplacement","twelve","16-List-w_-Images.png",false,$head);
	...
	$obj->fnDrawCallback = "function(oSettings){
                ...
                for ( var i=0 ; i<nTrs.length ; i++ )
                {
                    var iDisplayIndex = oSettings._iDisplayStart + i;
                     var sGroup = oSettings.aoData[ oSettings.aiDisplay[iDisplayIndex] ]._aData['Spot'];
